...
size_t packbits_write_file(const char* file, const unsigned char* data, size_t size)
{
    struct binio_file* bf;
    size_t             out_size;
...
size_t packbits_write(struct binio_file* bf, const unsigned char* data, size_t size)
{
